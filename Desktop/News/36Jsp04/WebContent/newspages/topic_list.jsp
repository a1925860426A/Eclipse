...
<div id="main">
  ...
  <div id="opt_area">
    <ul class="classlist">
     ...
     %>
      <li> &#160;&#160;&#160;&#160; <%=topic.getTname() %> &#160;&#160;&#160;&#160; <a href='../newspages/topic_modify.jsp?tid=<%=topic.getTid() %>&tname=<%=topic.getTname() %>'>修改</a> &#160;&#160;&#160;&#160; <a href='../util/topic_control.jsp?action=delete&tid=<%=topic.getTid() %>'>删除</a> </li>
      <%}%>
    </ul>
  </div>        
</div>
